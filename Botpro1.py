...
#vidia
kt = LINETCR.LINE()
kt.login(token="En2h1tGCsqKy5ZM2j2A2.EX9POTYx+gKdjKz7DQlnSG./5hJc91p8FXQkExd5oGOeB87cra3yuQhmJmTMnhz7oI=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="Ennz3JizkJJFMKAIPHV2.ZNOnP4uou95euS+Ku1ce4G.V/kc9Cm3euyvm7F3MLq7WLvFzmSoTIJKK3Nohopw9zQ=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
...
#iridessa
kc = LINETCR.LINE()
kc.login(token="En4fEPZ8IBZ2nUUfOpLd.6WqeC+1pukOllkvQ7Oglhq.m7o3gNWWMCJEkoLhAXgymM1CMP6bYkGyBBvplepM+YI=")
kc.loginResult()
...
helpMessage="""(􀠁􀠁☆─┅═ই╬TEAM BOT KILLERS ☆)(2 s 
➡➡➡(􀠁􀠁☆─┅═ই╬MODIFIKASI☆) 
⏳Bot1 rename:[text]
⌛Bot2 rename:[text]
⌛Bot3 rename:[text]
...
🔏Turn off bots
********************
CREATOR BYE https://line.me/ti/p/~boy29putra
➡➡➡@(􀠁􀠁☆─┅═ই╬TEAM BOT KILLERS ☆)(2 s ⬅⬅⬅
====================
"""
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"uc2e8b426f6591045943eae5304e67c32","uec09c371e4c19ae01aa3d84857440eb7","ub23ad49c409ac6773c4a151114e4761c","ueb040473fd4f50aa0b2ca56aee818b1d","uce7a0da7850e53de4452cfe4535084e2","u7b1f69a2dc97fc690326467b76a2cdb2"]
admin = ["uc2e8b426f6591045943eae5304e67c32"]
owner = ["uc2e8b426f6591045943eae5304e67c32","u7b1f69a2dc97fc690326467b76a2cdb2"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#================================================================================
	      ...
	      if msg.from_ in admin:
              ...
              if msg.from_ in admin and Bost:
                if msg.toType == 2:
...
#===============================================
		...
		if msg.from_ in admin or Bots:
		    ...
		    cl.sendText(msg.to, "Khusus admin or owner")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"Success recover")
	      ...
	      if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                print("Speed")
                start = time.time()
                cl.sendText(msg.to, "iya darling")
                elapsed_time = time.time() - start
		...
		kt.sendText(msg.to, "%sdetik" % (elapsed_time))
#========================================
